...
$result_servico = "SELECT * FROM servico";
...
$result_servico = "SELECT * FROM servico limit $incio, $quantidade_pg";
$resultado_servico = mysqli_query($conn, $result_servico);
$total_servico = mysqli_num_rows($resultado_servico);
?>
<!DOCTYPE html>
<html lang="pt-br">
	...
	<body>
		<div class="container theme-showcase" role="main">
			...
			<div class="row">
				<?php while($rows_servico = mysqli_fetch_assoc($resultado_servico)){ ?>
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail">
							<img src="tesoura.png" alt="...">
							<div class="caption text-center">
								<a href="detalhes.php?id_servico=<?php echo $rows_servico['id']; ?>"><h3><?php echo $rows_servico['nome']; ?></h3></a>
