  ...
  <div class="conteudo">
    <div id="cadastroform">
      <div class="formulario-container">
        ...
        <form action="proc_end-prof.php" method="POST">
          <div class="divs">
          ...
          <div class="divs">
            <h2 style="margin-bottom: 50px;">Endereço Profissional</h2>
            <div style="display: flex; justify-content: space-around;">
              <div>
                <label for="estado1">Estado:</label>
                <select id="estado1" name="estado" class="entrada-endereco">
                  <option value="" selected disabled>Selecione</option>
                  <option value="acre">Acre (AC)</option>
                  <option value="alagoas">Alagoas (AL)</option>
                  <option value="amapa">Amapá (AP)</option>
              ...
              <div>
                ...
                <input type="text" id="cidade1" class="entrada-endereco" name="cidade" required><br>
              </div>

              <div>
                <label for="bairro1">Bairro:</label>
                <input type="text" id="bairro1" class="entrada-endereco" name="bairro" required><br>
              </div>
            </div>
            <div style="display: flex; justify-content: space-around;">
              <div>
                <label for="rua1">Rua:</label>
                <input type="text" id="rua1" class="entrada-endereco" name="rua" required><br>
              </div>
              <div>
                <label for="numero1">Número:</label>
                <input type="text" id="numero1" class="entrada-endereco" name="numero" required><br>
              </div>
              <div>
                <label for="complemento1">Complemento:</label>
                <input type="text" id="complemento1" class="entrada-endereco" name="complemento"><br>
              </div>
              <div>
                <label for="cnpj">CNPJ:</label>
                <input type="text" id="cnpj" class="entrada-endereco" name="cnpj"><br>
              </div>
            </div>
          </div class="divs">
